    ...
    return (
        <Fragment>
            <div className='border-solid border-2 p-10 m-10 md:m-0 rounded-2xl border-white relative mt-8 md:mt-0'>
                ...
                <div className="sm:-top-1/3 sm:-left-1/10 hidden relative sm:flex">
                    <img
                        src="./img/Path 207@2x.png"
                        alt="path lg"
                        className={`absolute top-0 left-64 cursor-pointer hidden sm:flex ${zahedan ? '' : 'ring-4'}`}
                ...
                <img src="./img/Path 207@2x.png" alt="path lg" className='absolute top-4/10 left-4/10 cursor-pointer hidden sm:flex' />
                ...
                <img src="./img/Path 207@2x.png" alt="path lg" className='absolute top-28/100 left-2/4 cursor-pointer hidden sm:flex' />
                <img src="./img/Path 207.png" alt="path sm" className='absolute top-20 left-40 cursor-pointer flex sm:hidden' />
                <img src="./img/Path 207@2x.png" alt="path lg" className='absolute top-1/4 left-1/3 cursor-pointer hidden sm:flex' />
                <img src="./img/Path 207.png" alt="path sm" className='absolute top-20 left-28 cursor-pointer flex sm:hidden' />
                <img src="./img/Path 206@2x.png" alt="path lg" className='absolute top-2/4 left-2/4 cursor-pointer hidden sm:flex' />
                <img src="./img/Path 206.png" alt="path sm" className='absolute top-32 left-36 cursor-pointer flex sm:hidden' />
                <div className="sm:-top-3/4 sm:left-1/10 hidden relative sm:flex">
                    <img
                        src="./img/Path 206@2x.png"
                        alt="path lg"
                        className={`absolute sm:top-1/4 sm:left-2/3 cursor-pointer ${mashhad ? '' : 'ring-4'}`}
                ...
                <img src="./img/Path 206@2x.png" alt="path lg" className='absolute top-1/3 left-17/100 cursor-pointer hidden sm:flex' />
                <img src="./img/Path 206.png" alt="path sm" className='absolute top-24 left-20 cursor-pointer flex sm:hidden' />
                <img src="./img/Path 206@2x.png" alt="path lg" className='absolute hidden sm:flex top-17/100 left-1/10 cursor-pointer' />
